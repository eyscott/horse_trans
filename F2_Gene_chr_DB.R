...
j_u_equal_c_EN <- subset(unique_newdata_chr_EN,class_code.x.1 %in% c("j","=","u","c"))
...
#just manually inputting numbers for the Venn for 3 different Transcriptomes
#area1=subset(unique_newdata_chr_NCBI, select="major_iso_id.x"), 
#area2=totl number of transcripts, area3=total number of transcripts
#n12=j_equal_c_NCBI, n23=need to still do (took from paperfor now),n13=j_equal_c_EN, n123=duplicates removed from j_equal_both 
library(VennDiagram)
...
venn.plot <- draw.triple.venn(
  ...
  n13 = 21330,
  n123 = 16364,
  category = c("Mansour", "NCBI", "ENSEMBL"),
  fill = c("blue", "red", "green"),
  lty = "blank",
  cex = 2,
  cat.pos = c(325, 35, 180),
...
venn.plot <- draw.triple.venn(
  ...
  n13 = 21330,
  n123 = 16364,
  category = c("Mansour", "Hestand", "ISME"),
  fill = c("blue", "red", "green"),
  lty = "blank",
  cex = 2,
  cat.pos = c(325, 35, 180),
